...
TRANSFORMERS_CACHE=./HFCache HF_HOME=./HFCache CUDA_VISIBLE_DEVICES=0 vllm serve "Qwen/Qwen2-VL-72B-Instruct-AWQ" --dtype=half --tensor-parallel-size 1 --limit-mm-per-prompt image=3 --gpu_memory_utilization 0.95 --port 8002 > DSC_EDapi.log 2>&1 &
...
echo "API is ready. Running RunAPI.py" >> DSC_ErrorDetectionAtlasBench2Shot.log
...
# Log completion
echo "RunAPI.py has finished executing." >> DSC_ErrorDetectionAtlasBench2Shot.log
